      ...
      <ResponsiveContext.Consumer>
          {responsive => (responsive === 'smallmob') ? (
            <Footer background="#222323" pad="35px 25px 75px" align="center" justify="center" className="mainFooter">
              ...
              <ButtonFooter href="/GetPKT" label="Recover PKT" color="#FFFFFF" margin={{ top: "50px"}} hoverIndicator={{ color: "#FBA300", background: "#fff", border: "0", boxShadow: "0" }} />
              <ButtonFooter href="/GetWPKT" label="Recover WPKT" color="#FFFFFF" margin={{ top: "50px", bottom: "40px" }} hoverIndicator={{ color: "#FBA300", background: "#fff", border: "0", boxShadow: "0" }} />
