                ...
                <Card width="full" round="none" background="#fff" pad="75px 20px 100px">
                    <CardBody>
                            <Box background="#fff" justify="center" alignSelf="center">
                                ...
                                <StyledTextDark textAlign="center">Enter your PKT transaction ID, the address you sent your PKT from, and the BSC address you would like your WPKT sent to.</StyledTextDark>
                            </Box>
                    ...
                    <CardBody>
                        <Grid fill areas={[ { name: 'left', start: [0, 0], end: [0, 0] }, { name: 'right', start: [1, 0], end: [1, 0] },]}
                            ...
                            <Box gridArea="left" background="#fff" justify="center" alignSelf="start">
                                ...
                                <StyledTextDark textAlign="start" style={{ paddingRight: "6vw" }}>Enter your PKT transaction ID, the address you sent your PKT from, and the BSC address you would like your WPKT sent to.</StyledTextDark>
                            </Box>
