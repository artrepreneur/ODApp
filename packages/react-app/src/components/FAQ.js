...
import { themefont, ButtonCTA, HeadingDark , HeadingLight, ImageMobile } from ".";
  ...
  return (
    ...
    <ResponsiveContext.Consumer>
      {responsive => (responsive === 'small') ? (
        <Box direction="row" justify="left" align="center" height="85vh" pad={{ horizontal: "25px" }} round="none" style={bannerStyle}>
          <Box pad="medium" justify="left">
            <HeadingLight textAlign="center" margin="0 0 30px 0" level="1">FAQ</HeadingLight>
            ...
            <ButtonCTA label="Keep Reading" color="#FFFFFF" style={{position: "absolute", bottom: "75px", left: "0", right: "0"}} hoverIndicator={{ color: "#FBA300", background: "#fff", border: "0", boxShadow: "0" }} />
          </Box>   
        </Box>
      ) : (responsive === 'medium') ? (
        <Box direction="row" justify="left" align="center" pad={{ horizontal: "25px", vertical: "8rem"}} round="none" style={bannerStyle}>
          <Box pad="medium" justify="left">
            <HeadingLight textAlign="left" margin="0 0 50px 0" level="1">FAQ</HeadingLight>
            <Text align="left" size="22px" color="#ffffff" margin="0 ">The following is a compiled list of some of our most common questions.</Text>
        ...
        <Box direction="row" justify="left" align="center" height="large" pad={{ horizontal: "8rem" }} round="none" style={bannerStyle}>
          <Box pad="medium" justify="left">
            <HeadingLight textAlign="left" margin="0 0 4vw 0" level="1">FAQ</HeadingLight>
          ...
          <Card width="full" round="none" background="#fff" pad="0 50px" >
              <CardBody> 
                ...
                >
                  ...
                  <Box gridArea="left" justify="center" alignSelf="center">
                    <HeadingDark textAlign="left" margin="0 0 50px 0" level="2">What is a Bridge?</HeadingDark>
              ...
              <CardBody> 
                ...
                >
                  ...
                  <Box gridArea="left" height="large" justify="center" alignSelf="center" pad="0 10rem 0 8rem">
                    <HeadingDark textAlign="left" margin="0 0 50px 0" level="2">What is a Bridge?</HeadingDark>
                    <Text align="left" size="26px" color="#707070">A bridge is a connection point between two disparate blockchains. It allows chains that aren't connected in any way to bi-directionally communicate and transfer value. ODApp uses smart contracts, a bridge server, and Chainlink to transfer value from one chain to another.</Text>
                  </Box>                    
                </Grid>
              </CardBody>
          </Card>
              ...
              <CardBody> 
                ...
                >
                  ...
                  <Box gridArea="right" justify="center" alignSelf="center" pad="6rem 0">
                    <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">What is PKT?</HeadingLight>
          ...
          <Card width="full" round="none" background="#fff" pad="0 50px">
              <CardBody> 
                ...
                >
                  ...
                  <Box gridArea="left" justify="center" alignSelf="center">
                    <HeadingDark textAlign="left" margin="0 0 50px 0" level="2">What is WPKT?</HeadingDark>
                    <Text align="left" size="22px" color="#707070">WPKT is PKT on the ethereum blockchain. It is a wrapped version of PKT, hence the "W" in WPKT. WPKT can only come into existence when PKT is sent to the vault address, thus WPKT can't be inflated, and has a 1-to-1 peg to PKT. As there can only be 6 billion PKT in existence, there can never be more than 6 billion WPKT. WPKT is an ERC20 token and is compatible with all ERC20 platforms.</Text>
                  </Box>                    
                </Grid>
              </CardBody>
          ...
          <Card width="full" round="none" background="#fff" pad="none">
              <CardBody> 
                ...
                >
                  ...
                  <Box gridArea="left" justify="center" alignSelf="center" pad="0 9rem 0 8rem">
                    <HeadingDark textAlign="left" margin="0 0 50px 0" level="2">What is WPKT?</HeadingDark>
                    <Text align="left" size="26px" color="#707070">WPKT is PKT on the ethereum blockchain. It is a wrapped version of PKT, hence the "W" in WPKT. WPKT can only come into existence when PKT is sent to the vault address, thus WPKT can't be inflated, and has a 1-to-1 peg to PKT. As there can only be 6 billion PKT in existence, there can never be more than 6 billion WPKT. WPKT is an ERC20 token and is compatible with all ERC20 platforms.</Text>
                  </Box>                    
                </Grid>
              </CardBody>
          </Card>
          ...
          <Card width="full" round="none" background="#222323" pad="0 50px" style={vaultStyle}>
              <CardBody> 
                ...
                >
                  ...
                  <Box gridArea="right" justify="center" alignSelf="center" pad="6rem 0">
                    <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">What is the Vault?</HeadingLight>
          ...
          <Card width="full" round="none" background="#222323" pad="8rem" style={vaultStyle}>
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="right" justify="center" alignSelf="center" pad="0 0 0 8rem">
                        <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">What is the Vault?</HeadingLight>
              ...
              <Card width="full" round="none" background="#fff" pad="0 50px">
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="left" justify="center" alignSelf="center" pad="6em 0">
              ...
              <Card width="full" round="none" background="#222323" pad="0 50px">
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="right" justify="center" alignSelf="center">
                        <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">What is a Smart Contract?</HeadingLight>
                        <Text align="left" size="22px" color="#fff">A smart contract is a program that runs on top of a blockchain. As such, smart contracts can be used to issue tokens. ODapp uses smart contracts to issue WPKT on-chain.</Text>
                      </Box>                    
                    </Grid>
                  </CardBody>
              </Card>
          ...
          <Card width="full" round="none" background="#222323" pad="4rem 8rem">
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="right" justify="center" alignSelf="center" pad="0 0 0 10vw">
                        <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">What is a Smart Contract?</HeadingLight>
            ...
            <Card width="full" round="none" background="#fff" pad="0 50px" style={hashBg}>
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="left" justify="center" alignSelf="center" pad="4rem 0">
                        <HeadingDark textAlign="left" margin="0 0 50px 0" level="2">What is a Transaction Hash?</HeadingDark>
            ...
            <Card width="full" round="none" background="#222323" pad="0 50px">
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="right" justify="center" alignSelf="center" pad="4rem 0">
                        <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">I Didn't Save My Transaction Hash?</HeadingLight>
          ...
          <Card width="full" round="none" background="#222323" pad="8rem">
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="right" justify="center" alignSelf="center" margin={{left: "10rem", right: "2rem"}}>
                        <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">I Didn't Save My Transaction Hash?</HeadingLight>
                        <Text align="left" size="26px" color="#fff">If you lost your transaction hash, or didn't save it, you can recover it on-chain. Your Binance Smart Chain transactions are saved in your Metamask wallet, but you can also find them on etherscan. Just search for your Binance Smart Chain address and find the last transaction you performed off the address with the WPKT contract. Similarly, you can search for your PKT transaction hashes on the PKT explorer. To find your transaction hash, lookup the last transaction your PKT address executed against the address:<br /><br /><span style={{color: "#FBA300", textDecoration: "underlined"}}>pkt1qex9d4fjwc0nqr3x0hex6ds5vpu67efjdlm6ckz</span><br /><br />Once you have your transaction hashes, you can complete bridging in any case.</Text>
                      </Box>                    
                    </Grid>
                  </CardBody>
              </Card>
              ...
              <Card width="full" round="none" background="#fff" pad="0 50px" style={watchBg}>
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="left" justify="center" alignSelf="center" pad="4rem 0">
                        <HeadingDark textAlign="left" margin="0 0 50px 0" level="2">Why Does Bridging Take So Long?</HeadingDark>
            ...
            <Card width="full" round="none" background="#fff" pad="10rem 6rem 10rem 8rem" style={watchBg}>
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="left" height="large" justify="center" alignSelf="center" pad="0 5vw 0 0">
                        <HeadingDark textAlign="left" margin="0 0 50px 0" level="2">Why Does Bridging Take So Long?</HeadingDark>
                        <Text align="left" size="26px" color="#707070">Cross-chain bridging, as it is commonly known, is a process which involves settlement over two different chains. Normally, blockchain settlement over a single chain is limited to the speed of the chain. Every chain's speed is limited to its transactions per second (TPS) which is dependent on its block time. On average, Binance smart chain's block time is around 12 seconds while PKT cash's block time is 1 minute. In practice, we wait for several blocks of confirmation for a transaction to be approved, so we are waiting multiples of block time to settle. Additionally, Chainlink is used to create cross-chain communication. Chainlink adds additional latency to the process, via oracle requests. So, all of this together accounts for a slow settlement time. Bridging isn't exchanging or swapping, it is an entirely different process, and thus speed expectations should be adjusted to meet the realities of bridging.</Text>
                      </Box>                    
                    </Grid>
                  </CardBody>
              </Card>
            ...
            <Card width="full" round="none" background="#222323" pad="0 50px" style={precommitBridge}>
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="right" justify="center" alignSelf="center" pad="4rem 0">
                        <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">Why Must I Pre-Commit When Bridging WPKT?</HeadingLight>
          ...
          <Card width="full" round="none" background="#222323" pad="8rem" style={precommitBridge}>
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="right" justify="center" alignSelf="center" pad="0 0 0 10rem">
                        <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">Why Must I Pre-Commit When Bridging WPKT?</HeadingLight>
                        <Text align="left" size="26px" color="#fff">When bridging from PKT to WPKT it is important to pre-commit the PKT sender address as well as the WPKT recipient address (which is a Binance smart chain address). Sending funds to the vault address without performing this step first can result in your transaction being front-run by a malicious attacker. Specifically, an attacker may get your transaction id and submit it as their own. This can be prevented by pre-committing your sender / recipient pair before sending money to the vault. You must be sure to send money to the vault from the sender address you have declared. And your WPKT can only be received by the recipient address committed. It is important to note that all sender / recipient address pairs are unique. You cannot reuse the sender address with a different recipient or vice versa. You can reuse the same sender / recipient pair ad infinitum, but you can't mix and match to make new pairs using either declared address. If you wish to declare a new recipient address you must also add a new sender address. If you want to add a new sender you must also add a new recipient. Though it is somewhat limiting, the protection it offers far outweighs any inconvenience.</Text>
                      </Box>                    
                    </Grid>
                  </CardBody>
            </Card>
    ...
    {responsive => (responsive === 'small') ? (
      <Box>
        <Card width="full" round="none" background="#fff" pad="70px 25px 0">
            ...
            <Box justify="start"><Image alignSelf="center" src={recive_pkt_illustration_mob} fit="contain" /></Box>            
        </Card>
      </Box>  
    ) : (responsive === 'medium') ? (
      <Box>
        <Card width="full" round="none" background="#fff" pad="0 50px" style={receivePKT}>
            <CardBody> 
              ...
              >
                ...
                <Box gridArea="left" justify="center" alignSelf="center" pad="6rem 0">
                  <HeadingDark textAlign="left" margin="0 0 50px 0" level="2">Why Didn't I Receive PKT?</HeadingDark>
            ...
            <Card width="full" round="none" background="#222323" pad="0 50px" style={receiveWPKT}>
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="right" justify="center" alignSelf="center" pad="6rem 0">
                        <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">Why Didn't I Receive WPKT?</HeadingLight>
                        <Text align="left" size="22px" color="#fff">If you didn't receive WPKT your transaction failed. This can happen for many reasons, but the solution in any case is inevitably the same. You simply need to perform the transaction again using your PKT transaction hash as proof of transaction (PoTx).</Text>
                      </Box>                    
                    </Grid>
                  </CardBody>
              </Card>
        ...
        <Box>
            <Card width="full" round="none" background="#222323" pad="12rem 8rem" style={receiveWPKT}>
                  <CardBody> 
                    ...
                    >
                      <Box gridArea="left" justify="start"></Box>
                      <Box gridArea="right" justify="center" alignSelf="center" pad="0 0 0 9vw">
                        <HeadingLight textAlign="left" margin="0 0 50px 0" level="2">Why Didn't I Receive WPKT?</HeadingLight>
                        <Text align="left" size="26px" color="#fff">If you didn't receive WPKT your transaction failed. This can happen for many reasons, but the solution in any case is inevitably the same. You simply need to perform the transaction again using your PKT transaction hash as proof of transaction (PoTx).</Text>
                      </Box>                    
                    </Grid>
                  </CardBody>
              </Card>
            ...
            <Card width="full" round="none" background="#fff" pad="0 50px" >
                  <CardBody> 
                    ...
                    >
                      ...
                      <Box gridArea="left" justify="center" alignSelf="center">
                        <HeadingDark textAlign="left" margin="0 0 50px 0" level="2">Why Didn't I Receive the Balance I Expected?</HeadingDark>
