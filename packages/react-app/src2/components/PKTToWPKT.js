  ...
  return (
    ...
    <BodyCenteredAlt>
      <Card width="xlarge" background="light-1" pad="none">
             ...
             <Text size="large" textAlign="left" margin="small">To convert your 1PKT to WPKT you will first need to send your 1PKT to ODApp's "VAULT" address, seen below, using the 1PKT wallet of your choice. 
              Be sure to save your transaction ID, which is provided by your wallet, as proof of your transaction. You will need this <Text style={{fontWeight: "bold"}}>transaction ID</Text> to get your 1PKT onto ethereum's chain. </Text>
                <Card pad="medium" style={{backgroundColor: '#2B2F36'}}>
                    <CardBody>
                    <h4 align="center" style={{color: '#F0B90C'}}>Send Your 1PKT Here: </h4>
